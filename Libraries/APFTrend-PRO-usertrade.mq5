...
int getUserSignal(const int type, const int idx, const int i, const datetime &time[],
        ...
        const double &color_line[], const double &VWAP[], const double &HILO[], const double &HILO2[], const double &SAR[], const double &RSI[], const double &MFI[], const double &ATR[],
